...
public enum TeamExceptionEnum {
     ...
     * 业务异常
     */
    ALREADY_IN_TEAM(TEAM_EXCEPTION_PREFIX + "000", "您已经处于组队状态"),
    NOT_IN_TEAM(TEAM_EXCEPTION_PREFIX + "001", "您没有加入小队"),
    ...
    PRE_JOIN_NOT_FREE(TEAM_EXCEPTION_PREFIX + "009", "您当前处于非空闲状态，仅空闲状态可申请加入小队"),
