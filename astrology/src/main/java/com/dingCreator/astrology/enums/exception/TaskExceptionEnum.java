...
public enum TaskExceptionEnum {
    ...
    PEAK_PLAYER_IS_MOVING(new BusinessException(Constants.TASK_EXCEPTION_PREFIX + "003", "移动中不允许接取巅峰任务")),
    ...
    ALREADY_COMPLETE(new BusinessException(Constants.TASK_EXCEPTION_PREFIX + "008", "任务已完成")),
    ALREADY_FAILED(new BusinessException(Constants.TASK_EXCEPTION_PREFIX + "009", "任务已失败")),
    ;
