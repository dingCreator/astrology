...
public enum EquipmentEnum {
    ...
    EQUIPMENT_1(1L, "破碎的剑柄",
            ...
            Arrays.asList(
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.BEHAVIOR_SPEED, 10L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.DODGE, 10L)
            ),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_2(2L, "武士刀的断刃",
            "捡来的武士刀碎片，无法用来攻击，但可以贴在身上当防具使用",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.DEF, 5L)),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_3(3L, "星术废纸",
            "垃圾典籍上撕下来的废纸，在如厕没有带纸的时候可以撕下来应急",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.HP, 100L)),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_4(4L, "腐烂的桃木屑",
            "腐烂的桃木碎屑，打架的时候可以扬在对方脸上让他们看不清东西",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.DEF, 20L)),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_5(5L, "生锈的枪膛",
            "破烂的枪膛，没什么用处，直接往对方脸上扔，砸一下也挺疼的",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 5L)),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_6(6L, "兽角",
            "不知道是何种兽角，似乎没有任何能量遗留在上面，本身也不算坚硬，但用来顶一下人还是可以的",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 6L)),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_7(7L, "大骨棒子",
            "野外随意捡来的还算完整的大骨棒子，砸人还挺顺手的",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 7L)),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_8(8L, "轰天雷",
            "只是一种名叫“轰天雷”的鞭炮罢了",
            Arrays.asList(
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 10L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.HIT, -5L)
            ),
            EquipmentRankEnum.SP, EquipmentTypeEnum.WEAPON
    ),
    ...
    EQUIPMENT_100(100L, "生锈的铁剑",
            "已经生锈的铁剑，似乎还能用？",
            Arrays.asList(
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 8L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.BEHAVIOR_SPEED, 5L)
            ),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_101(101L, "生锈的武士刀",
            "一把生锈的武士刀，切菜应该没什么问题",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 14L)),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_102(102L, "腐朽的桃木棍",
            "老神棍骗术的精髓，不过已经腐朽不堪",
            Arrays.asList(
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 6L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.DODGE, 6L)
            ),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_103(103L, "蒙尘的星术秘典",
            "星术家族用来垫桌脚的书，上面有很多灰尘",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.MAGIC_ATK, 16L)),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_104(104L, "会卡壳的格洛克手枪",
            ...
            Arrays.asList(
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 10L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.PENETRATE, 0.1F)
            ),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_105(105L, "黑色石碑",
            ...
            Arrays.asList(
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 15L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.BEHAVIOR_SPEED, -10L),
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.HIT, -10L)
            ),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    EQUIPMENT_106(106L, "款式独特的玉佩",
            "土里偶然挖出来的，款式与现代的款式都不相同，上面也没有任何文字，无法辨别是何人遗失的。似乎也无法作为正常武器使用。",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 2L)),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.JEWELRY
    ),
    EQUIPMENT_107(107L, "锄头",
            "农夫种地的农具，也是农民起义常用武器之一",
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 10L)),
            EquipmentRankEnum.ORDINARY, EquipmentTypeEnum.WEAPON
    ),
    ...
    EQUIPMENT_109(109L, "量产型一阶剑符",
            ...
            Collections.singletonList(new EquipmentPropertiesDTO(PropertiesTypeEnum.ATK, 20L)),
    ...
    EQUIPMENT_200(200L, "精致的钢剑",
            ...
            Arrays.asList(
                    ...
                    new EquipmentPropertiesDTO(PropertiesTypeEnum.BEHAVIOR_SPEED, 50L)
            ),
